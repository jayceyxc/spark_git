package com.linus.dataalgorithms.spark.secondary_sort;


// STEP-0: import required Java/Spark classes.

import com.linus.dataalgorithms.utils.SparkUtil;
...
public class SecondarySortUsingGroupByKey {
    public static void main (String[] args) throws Exception {
        ...
        // STEP-7: validate STEP-6, weCustomPartitioner.java
        ...
        //TupleComparatorDescending.java collect all values from JavaPairRDD<> and print it.
